  ...
  return (
    <>
      <main className="md:grid-rows-bento-grid-tablet lg:grid-rows-bento-grid-desktop grid grid-cols-1 gap-8 px-4 py-8 md:grid-cols-2 md:px-10 md:py-14 lg:mx-auto lg:max-w-[1200px] lg:grid-cols-[repeat(4,256px)]">
        ...
        <ScheduleSection gridPosition="md:col-span-2 lg:col-span-1 lg:col-start-4 lg:row-span-3 lg:row-start-1" />
      ...
      <footer className="pb-4 text-center text-xs">
        <p>
          Challenge from{" "}
          <a
            href={FRONTEND_MENTOR_PROFILE_URL}
            target="_blank"
          ...
          , by{" "}
          <a href={PORTFOLIO_URL} target="_blank" className="text-primary-500">
            Maxence WOLFF
          </a>
        </p>
      </footer>
